...
if cmd == 'moderator' and not is_mod(msg) or cmd == 'owner' and n

ot is_owner(msg) then
...
return tdcli.sendDocument(msg.chat_id_, 0, 0, 1, nil, './Fun/ping.gif', '@TiGeRTeM', dl_cb, nil)
...
  tdcli.sendMessage(msg.chat_id_, 0, 1, text, 1
...
--------------------------------
 ...
 if matches[1]:lower() == "sticker" or matches[1]:lower() == "Sticker" or matches[1]:lower() == "استیکر" then 
  ...
  local url = "https://assets.imgix.net/examples/clouds.jpg?blur=150&w="..w.."&h="..h.."&fit=crop&txt="..eq.."&txtsize="..txtsize.."&txtclr="..tx

tclr.."&txtalign=middle,center&txtfont=Futura%20Condensed%20Medium&mono=ff6598cc"
...
--------------------------------
 ...
 if matches[1]:lower() == "photo" or matches[1]:lower() == "Photo" or matches[1]:lower() == "عکس" then 
  ...
  tdcli.sendPhoto(msg.to.id, 0, 0, 1, nil, file, "@TiGeRTeM", dl_cb, nil)
