--Begin BanHammer.lua By @Arashsud
...
     return tdcli.sendMessage(arg.chat_id, "", 0,
...
 return tdcli.sendMessage(msg.to.id, msg.id, 0, "*User "..mat

ches[2].." has been globally banned*", 0, "md")
...
   end
  ...
  if matches[1]:lower() == 'clean' an

d is_owner(msg) or matches[1]:lower() == 'Clean' and is_owner(msg) or matches[1]:lower() == 'پاک کردن' and is_owner(msg) then
